...
CLASS lcl_helper IMPLEMENTATION.
  ...
  METHOD htmldiff.
    ...
    DATA(li_htmldiff) = /apmg/cl_html_diff=>create(
...
CLASS /apmg/cl_html_diff DEFINITION LOCAL FRIENDS ltcl_calculate_operations.
...
CLASS ltcl_calculate_operations DEFINITION FOR TESTING
  ...
  PRIVATE SECTION.
    ...
    DATA mo_htmldiff TYPE REF TO /apmg/cl_html_diff.
...
CLASS ltcl_calculate_operations IMPLEMENTATION.
  ...
  METHOD action_middle.
    ...
    DATA ls_exp TYPE /apmg/cl_html_diff=>ty_operation.
...
CLASS ltcl_diff DEFINITION FOR TESTING
  ...
  PRIVATE SECTION.
    ...
    DATA mi_htmldiff TYPE REF TO /apmg/if_html_diff.
...
CLASS ltcl_diff IMPLEMENTATION.
  ...
  METHOD setup.
    mi_htmldiff = NEW /apmg/cl_html_diff( ).
  ENDMETHOD.
...
CLASS /apmg/cl_html_diff DEFINITION LOCAL FRIENDS ltcl_find_matching_blocks.
...
CLASS ltcl_find_matching_blocks IMPLEMENTATION.
  ...
  METHOD find_match_1.
    ...
    DATA ls_exp TYPE /apmg/cl_html_diff=>ty_match.
...
CLASS /apmg/cl_html_diff DEFINITION LOCAL FRIENDS ltcl_html_to_token.
...
CLASS ltcl_html_to_token IMPLEMENTATION.
  ...
  METHOD test.
    ...
    DATA lt_exp TYPE /apmg/cl_html_diff=>ty_tokens.
...
CLASS /apmg/cl_html_diff DEFINITION LOCAL FRIENDS ltcl_render_operations.
